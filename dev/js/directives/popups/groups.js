        ...
        action: () => {
          ...
          ajaxAPI.groups.add({ title: addForm.title }).then(r => {
            ...
            if (r.id) {
              ...
              notify
                .update({
                  text: messages.groups.success.add,
                  icon: 'fa-plus-circle',
                })
                .show();
              addForm.title = '';
              ...
              notify
                .update({ text: messages.groups.error, icon: 'fa-warning' })
                .show();
            }
          });
        },
        ...
        action: g => {
          ...
          ajaxAPI.groups.edit(g.id, { title: g.copy }).then(r => {
            ...
            if (r == 1) {
              ...
              notify
                .update({
                  text: messages.groups.success.edit,
                  icon: 'fa-check',
                })
                .show();
            } else {
      ...
      const actions = {
        reorder: (item, f, t) => {
          ...
          ajaxAPI.groups.reorder(mod).then(r => {
            if (r) {
              ...
              notify
                .update({
                  text: messages.groups.success.reorder,
                  icon: 'fa-check',
                })
                .show();
            } else {
        ...
        delete: id =>
          $scope.confirm.open({
            ...
            agree: () =>
              ajaxAPI.groups.delete(id).then(r => {
                if (r == 1) {
                  // Remove group
                  ...
                  notify
                    .update({
                      text: messages.groups.success.delete,
                      icon: 'fa-trash-o',
                    })
                    .show();
                } else {
